...
(fn draw-sprite! [{: sprite : w : h : scale : trans : x : y
  ...
  (let [sprite (pick-animated-sprite { : ticks : w : sprite : animate})
        ...
        x (+ x (or shift-x 0))
        y (+ y (or shift-y 0))]
    (if box (draw-box! (merge box {:x x :y y :w full-w :h full-h})))
...
(defscreen $screen :intro
  {:tick
   ...
   (fn []
     (poke 0x03FF8 8)
     ($ui:clear-all!)
     (dialog-chain #($screen:select! :game)
                   {:box {:x 34}
...
(fn draw-hud [{: entities &as game} { : color-bar : ticks}]
  (let [portals (filterv #(?. $ :portal) entities)
        critters (filterv #(?. $ :critter) entities)]
    (print (.. "ticks: " ticks) 10 20 13)
...
;; 019:
...
;; 022:
...
;; 024:
...
;; 026:
;; 027:
;; 028:
;; 029:
;; 030:
;; 031:
;; 032:
;; 033:
;; </MAP>
