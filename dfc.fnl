...
(fn enemy-react [{: color &as self}
  ...
  (let [x (if dx (+ x dx) x)
        y (clamp (if dy (+ y dy) y)
                 (+ (* bounds.y 8) 1)
                 (- (* (+ bounds.y bounds.w) 8) 10))
        dx (if (or (< x (* bounds.x 8))
                   (> x (* (+ bounds.x bounds.w) 8)))
               (- 0 dx)
               dx)
        dy (if (or (< y (* bounds.y 8)) (> y (* (+ bounds.y bounds.h) 8)))
               (- 0 (or dy 1))
               (math.sin (/ ticks 40)))
...
(fn build-home-portal [{: color : hp &as base-state}]
  (let [color (or color :white)
        sprite (?. enemy-portal-colors color)]
    {:render (fn [self {: timer-ticks &as state} game]
               (print (.. "Time Remaining... " (- 60 (// (or timer-ticks 0) 60)) "s")
                      120 60 13)
               (draw-entity self state game))
...
(fn draw-hud [{: entities &as game} { : screen-x : screen-y : color-bar : ticks}]
...
;; 192:0000d000000000000000000000c0000000000000000000d00400000000000000
...
;; 001:
...
;; 005:
...
;; 011:
...
;; 013:
...
;; 015:
...
;; 017:
;; 018:
;; 019:
;; 020:
;; 021:
;; 022:
;; 023:
;; 024:
;; 025:
;; 026:
;; 027:
;; 028:
;; 029:
;; 030:
;; 031:
;; 032:
;; 033:
...
;; 036:
;; 037:
;; 038:
;; 039:
;; 040:
;; 041:
;; 042:
;; 043:
;; 044:
;; 045:
;; 046:
;; 047:
;; 048:
;; 049:
;; 050:
;; 053:
;; 054:
;; 055:
;; 056:
;; 057:
;; 058:
;; 059:
;; 060:
;; 061:
;; 062:
;; 063:
;; 064:
;; 065:
;; 066:
;; 067:
;; 068:
;; </MAP>
...
;; <PATTERNS>
;; 000:
